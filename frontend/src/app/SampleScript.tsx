            ...
            <div className={styles.scriptContent}>
              <div>
                ...
                <p className={styles.scriptIntro}>
                  Utilize this script when commenting under a politician's post or direct message!
                </p>
              </div>
              <p className={styles.scriptText}>
                "Hi [Politician's Handle], LA County needs more funding for low-cost spay and neuter
                programs! Increased access to these services means fewer homeless pets, lower
                shelter intake, and a healthier community. Please support funding for these vital
                programs!"
              </p>
            </div>
          </div>
        ...
        <div className={styles.scriptSection}>
          ...
          <div className={styles.scriptCard}>
            <div className={styles.scriptContent}>
              ...
              <p className={styles.scriptText}>
                "Dear [Politician's Name], I'm reaching out as a concerned community member to ask
                for your support in increasing funding for low-cost spay and neuter programs in LA
                County. These services help reduce pet homelessness, lower shelter euthanasia rates,
                and improve public health. Please take action to fund these critical programs and
                help protect our animals. Thank you!"
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={styles.scriptSection}>
          ...
          <div className={styles.scriptCard}>
            <div className={styles.scriptContent}>
              ...
              <p className={styles.scriptText}>
                "Hi, my name is [Your Name], and I'm a resident of [Your City]. I'm calling to
                express my support for increased funding for low-cost spay and neuter programs in LA
                County. These programs help reduce pet overpopulation, decrease shelter euthanasia
                rates, and support our community's public health. I urge you to prioritize funding
                for these essential services. Thank you for your time!"
              </p>
            </div>
          </div>
